...
namespace Birds.Test.ServicesTests
{
    public class CountryServiceTests
    {
        ...
        public async Task DeleteCountry_ReturnTrue()
        {
            // Arrange
            int countryId = 1;
            Country returnCountry = new Country { Id = countryId, NameCountry = "Country 1" };
        ...
        public async Task GetCountry_ReturnCountry()
        {
            // Arrange
            int countryId = 1;
            Country expectedCountry = new Country { Id = countryId, NameCountry = "Country 1" };
        ...
        public async Task GetCountries_ReturnPagedListCountries()
        {
            ...
            {
                new Country { Id = 1, NameCountry = "Country 1" },
                new Country { Id = 2, NameCountry = "Country 2" },
                new Country { Id = 3, NameCountry = "Country 3" },
                new Country { Id = 4, NameCountry = "Country 4" },
            };
        ...
        {
            // Arrange
            Country country = new Country { Id = 1, NameCountry = "Country 1" };
